                            ...
                            <div class="card-body">
                                ...
                                <div class="card-block">
                                    <div class="item_row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" name="open_balance"
                                                        value="{{ @$cash_in_hand }}" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <br />
                                        <h3>Receipts</h3><br />
                                        <form class="ajaxForm" role="form" action="{{ route('admin.cash.store') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="date" required
                                                            ...
                                                            name="date"
                                                            value="{{ isset($is_update_receipt) ? date('Y-m-d', strtotime(@$edit_receipt->entry_date)) : date('Y-m-d') }}"
                                                            required>
                                                        ...
                                                        <select class="form-control select2" style="width: 100%;"
                                                            ...
                                                            @foreach ($accounts as $account)
                                                                <option value="{{ $account->hashid }}"
                                                                    @if (@$edit_receipt->account_id == $account->id) selected @endif>
                                                                    {{ $account->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="bil_no"
                                                            value="{{ @$edit_receipt->bil_no }}" required>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <datalist id="cityname">
                                                            @forelse($accounts AS $account)
                                                                <option style="width:300px;" value="{{ $account->name }}"
                                                                    @if (@$edit_receipt->account_id == $account->id) selected @endif>
                                                                    {{ $account->name }}</option>
                                                            @empty
                                                                <option style="width:300px;" value="">No Account
                                                                    Found!</option>
                                                            @endforelse
                                                        </datalist>
                                                        <input class="form-control" name="narration"
                                                            value="{{ @$edit_receipt->narration }}" autocomplete="on"
                                                            style="width:920px;" list="cityname">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label>Amount </label>
                                                        <input class="form-control" type="number" name="receipt_ammount"
                                                            value="{{ @$edit_receipt->receipt_ammount }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-1 mt-3">
                                                    <div class="form-group">
                                                        <button type="reset" class="btn btn-danger "><i
                                                                class="fa fa-repeat" aria-hidden="true"></i>&nbsp
                                                            Reset</button>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="cash_id"
                                                    value="{{ @$edit_receipt->hashid }}">
                                                <div class="col-md-1 mt-3">
                                                    <div class="form-group">
                                                        <button type="submit"
                                                            value="{{ @$is_update_receipt ? 'Update' : 'Add' }}"
                                                            name="save_receipt" class="btn btn-success">&nbsp Save
                                                        </button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="date" name="date"
                                                            value="{{ @$is_update_payment ? date('Y-m-d', strtotime($edit_payment->entry_date)) : date('Y-m-d') }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="cash_id"
                                                    value="{{ @$edit_payment->hashid }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control select2" id="payment_account"
                                                            ...
                                                            @foreach ($accounts as $account)
                                                                <option value="{{ $account->hashid }}"
                                                                    @if (@$edit_payment->account_id == $account->id) selected @endif>
                                                                    {{ $account->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label>Instrument No </label>
                                                        <input class="form-control" name="bil_no"
                                                            value="{{ @$edit_payment->bil_no }}" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="narration" autocomplete="on"
                                                            value="{{ @$edit_payment->narration }}" style="width:920px;"
                                                            list="cityname">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label>Amount </label>
                                                        <input class="form-control" name="payment_ammount"
                                                            value="{{ @$edit_payment->payment_ammount }}" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-1 mt-3 ">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-1 mt-3 ">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="submit"
                                                            value="{{ isset($is_update_payment) ? 'Update' : 'Add' }}"
                                                            name="save_payment" class="btn btn-success">&nbsp Save
                                                        </button>
                                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($cash as $c)
                                            <tr class="text-dark">
                                                ...
                                                <td>{{ $c->bil_no }}</td>
                                                <td><span
                                                        class="waves-effect waves-light btn btn-primary-light">{{ @$c->account->name }}</span>
                                                </td>
                                                <td>{{ $c->narration }}</td>
                                                <?php $total_receipt += $c->receipt_ammount;
                                                $total_payment += $c->payment_ammount; ?>
                                                ...
                                                <td width="120">
                                                    <div class="btn-list">
                                                        ...
                                                        <a href="{{ route('admin.cash.show', ['id' => $c->id, 'generate_pdf' => 1]) }}"
