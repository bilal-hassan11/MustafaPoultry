        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-12 col-lg-6">
                ...
                <div class="card-body text-center">
                    ...
                    <h4 class="text-dark counter mt-0 mb-3 number-font">{{ $tot_purchase_return_feed_ammount }}</h4>
                    <div class="progress h-1 mt-0 mb-2">
                    ...
                    <div class="col text-center">
                        ...
                        <span class="text-muted">Ammount</span>
                        <h4 class="fw-normal mt-2 mb-0 number-font1">{{$tot_purchase_return_feed_ammount}}</h4>
                    </div>
                    </div>
                </div>
                </div>
        ...
        <div class="row">
                    ...
                    <div class="card-header border-bottom justify-content-between">
                            ...
                            <div class="col-lg-5 float-right">
                                <select class="form-control 
                                    select2" name="sale_category" id="sale_category" >
            ...
            <div class="col-xl-4 col-md-12">
                ...
                <div class="card-header">
                    ...
                    <div class="col-lg-5 float-right">
                        <select class="form-control 
                            select2" name="category_id" id="category_id" >
                                <option value="chick">Chick</option>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover text-nowrap">
                        ...
                        <tr>
                            ...
                            <td><span
                                    ><i
                                    class="ri-arrow-up-s-fill me-1 text-success align-middle fs-18"
                                    ></i
                                    >23,379</span
                                ></td>
...
<script>
    $(document).ready(function() {
        $('#sale_category').change(function() {
            ...
            if (category) {
                $.ajax({
                    url: `{{ route('admin.common.latest.sale', ':category') }}`.replace(':category',category),
                    type: 'GET',
                    dataType: 'json',
