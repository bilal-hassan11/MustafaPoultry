                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="0%"
                                                    value="{{ @$edit_account->commission }}" min="0" max="100"
                                                    name="commission" id="commission">
                                            </div>
                                            <div class="col-md-3 form-group">
                                                <label for="">Discount</label>
                                                <input type="number" class="form-control" placeholder="0%"
                                                    value="{{ @$edit_account->discount }}" min="0" max="100"
                                                  ...
                                                  @endif
                                                                ...
                                                                <td width="180">
                                                                    <div class="btn-list">
                                                                        ...
                                                                        @endcan
                                                                        @can('Accounts Delete')
                                                                        <button type="button" onclick="ajaxRequest(this)" data-url="{{ route('admin.accounts.delete', $account->hashid) }}"
