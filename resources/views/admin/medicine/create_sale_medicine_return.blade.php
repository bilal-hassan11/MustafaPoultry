        ...
        <div class="side-app">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Create Sale Medicine Return</h4>
                ...
                <form id="formData">
                    ...
                    <div class="card-body" style="width: 100%; overflow-x: auto">
                        <div class="alert alert-info py-2">
                            ...
                            <strong>Sale Return</strong> adds medicine back to stock. No stock availability check is required.
                        </div>
                ...
                $.ajax({
                    ...
                    success: function () {
                        Swal.fire({ icon: 'success', title: 'Success',
                                    text: 'Sale Medicine Return saved!' })
                            .then(() => {
