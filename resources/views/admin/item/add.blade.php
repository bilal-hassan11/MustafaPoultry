                    ...
                    <form action="{{ route('admin.items.store') }}" class="ajaxForm" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="submit" value="Add" class="btn btn-primary mt-2 float-right" style="float:right">
                            </div>
                        </div>
                    </form>
                    @endcan
                ...
                @if(isset($is_update))
                    ...
                    <form action="{{ route('admin.items.store') }}" class="ajaxForm" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <input type="hidden" value="{{ @$edit_item->hashid }}" name="item_id" id="item_id">
                                <input type="submit" value="Update" class="btn btn-primary mt-2 float-right" style="float:right">
                            </div>
                        </div>
                    </form>
                    @endcan
