                    ...
                    <aside class="app-sidebar open ps ps--active-y">
                        ...
                        <div class="main-sidemenu is-expanded">
                            ...
                            <ul class="side-menu open" style="margin-right: 0px; margin-left: 0px;">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item {{ request()->is('chick-invoices/purchase') || request()->is('chick-invoices/sale') ? 'active' : '' }}"
                                    ...
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="{{ route('admin.chick-invoices.purchase') }}"
                                                class="slide-item  {{ request()->is('chick-invoices/purchase') ? 'active open' : '' }}">
                                                Purchase Chick</a></li>
                                        <li><a href="{{ route('admin.chick-invoices.sale') }}"
                                                class="slide-item {{ request()->is('chick-invoices/sale') ? 'active open' : '' }}">
                                                Sale
                                                Chick</a></li>
                                ...
                                <!-- Feed -->
                                <li class="slide">
                                    <a class="side-menu__item {{ request()->is('feed-invoices/purchase') || request()->is('feed-invoices/sale') ? 'active' : '' }}"
                                    ...
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="{{ route('admin.feed-invoices.purchase') }}"
                                                class="slide-item {{ request()->is('feed-invoices/purchase') ? 'active open' : '' }}">
                                                Purchase Feed</a></li>
                                        <li><a href="{{ route('admin.feed-invoices.sale') }}"
                                                class="slide-item {{ request()->is('feed-invoices/sale') ? 'active open' : '' }}">
                                                Sale
                                                Feed</a></li>
                                ...
                                <!-- Medicine -->
                                <li class="slide">
                                    <a class="side-menu__item {{ request()->is('medicine-invoices/purchase') || request()->is('medicine-invoices/sale') ? 'active' : '' }}"
                                    ...
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="{{ route('admin.medicine-invoices.purchase') }}"
                                                class="slide-item {{ request()->is('medicine-invoices/purchase') ? 'active open' : '' }}">
                                                Purchase Medicine</a></li>
                                        <li><a href="{{ route('admin.medicine-invoices.sale') }}"
                                                class="slide-item {{ request()->is('medicine-invoices/sale') ? 'active open' : '' }}">
                                                Sale Medicine</a></li>
                                ...
                                <!-- Murghi -->
                                <li class="slide">
                                    <a class="side-menu__item {{ request()->is('murghi-invoices/purchase') || request()->is('murghi-invoices/sale') ? 'active' : '' }}"
                                    ...
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="{{ route('admin.murghi-invoices.purchase') }}"
                                                class="slide-item {{ request()->is('web_admin/murghi-invoices/prchase') ? 'active open' : '' }}">
