        ...
        <div class="side-app">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Create Purchase Medicine Return</h4>
...
@section('page-scripts')
    <script type="text/javascript">
        // stockData: stdClass objects from getStockInfo() — item_id = real items.id
        ...
        $(document).ready(function () {
            ...
            $("#formData").submit(function (e) {
                ...
                $('tr.rows').each(function () {
                    ...
                    let max = parseFloat($(this).find('.quantity').attr('max')) || Infinity;
                    if (qty > max) {
                        toastr.error('Quantity exceeds available stock (' + max + ').');
                        valid = false;
                        return false;
                    }
                });
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        Swal.fire({ icon: 'success', title: 'Success',
                                    text: 'Purchase Medicine Return saved!' })
                            .then(() => {
