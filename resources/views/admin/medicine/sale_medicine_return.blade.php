                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4 class="mb-0">Sale Medicine Return</h4>
                            <a href="{{ route('admin.medicine-invoices.sale_return.create') }}"
                               class="btn btn-primary btn-sm">
                                <i class="ri-add-line"></i> New Return
                            </a>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.medicine-invoices.sale_return.index') }}" method="GET">
                                <div class="row g-2">
                                    <div class="col-md-3">
                                        <label>Account</label>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mb-0">All Sale Medicine Returns</h3>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($returns as $return)
                                            <tr class="text-dark">
                                                ...
                                                <td>{{ $return->quantity > 0 ? number_format($return->net_amount / $return->quantity, 2) : '-' }}</td>
                                                @php $tot_q += $return->quantity; @endphp
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a class="btn btn-outline-info rounded-pill btn-wave"
                                                           href="{{ route('admin.medicine-invoices.sale_return.show', $return->invoice_no) }}"
                                                           title="View"><i class="ri-eye-line"></i></a>
                                                        <a class="btn btn-outline-warning rounded-pill btn-wave"
                                                           href="{{ route('admin.medicine-invoices.sale_return.edit', $return->invoice_no) }}"
                                                           title="Edit"><i class="ri-edit-line"></i></a>
                                                        <a class="btn btn-outline-info rounded-pill btn-wave"
                                                           href="{{ route('admin.medicine-invoices.sale_return.show', [$return->invoice_no, 'generate_pdf' => 1]) }}"
                                                           target="_blank" title="PDF"><i class="ri-download-2-line"></i></a>
                                                        <a class="btn btn-outline-danger rounded-pill btn-wave"
                                                           href="{{ route('admin.medicine-invoices.sale_return.delete', $return->invoice_no) }}"
                                                           title="Delete"
                                                           onclick="return confirm('Delete this return? This will reverse the stock addition.')">
